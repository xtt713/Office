                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        if (data.length < 5) {
                            ...
                            for (var i = 0; i < data.length; i++) {
                                //html += "<li name='" + data[i].ID + "' class='" + result[i].class + "' style='line-height:120;height:80px;width:120px;display:inline-block;text-align:center;border-radius: 5px;background-color:white;margin-left:1%;margin-top:2vh;font-size:15px;font-weight:bold;color:" + result[i].Color + "'>" + data[i].HouseName + "</li>";
                               
                                html += "<li name='" + data[i].ID + "' class='" + result[i].class + "' style='text-align:center;line-height:7vh;height:7vh;width:120px;display:inline-block;border-radius: 5px;color:#FFFFFF;margin-left:1%;margin-top:1vh;font-size:15px;font-weight:bold;background-color:" + result[i].Color + "'>" + data[i].HouseName + "</li>";
                            }
                        } else {
                            $("#houseInfo").css("padding-top", "2vh");
                            $("#houseInfo").css("text-align", "left");
                            for (var i = 0; i < data.length; i++) {
                                //html += "<li name='" + data[i].ID + "' class='" + result[i].class + "' style='text-align:center;line-height:7vh;height:80px;width:80px;display:inline-block;text-align:center;border-radius: 5px;background-color:white;margin-left:1%;margin-top:2vh;font-size:15px;font-weight:bold;color:" + result[i].Color + "'>" + data[i].HouseName + "</li>";
                                html += "<li name='" + data[i].ID + "' class='" + result[i].class + "' style='text-align:center;line-height:7vh;height:7vh;width:" + that.left +";display:inline-block;text-align:center;border-radius: 5px;margin-left:1%;margin-top:1vh;color:#FFFFFF;margin:6px;font-size:15px;font-weight:bold;background-color:" + result[i].Color + "'>" + data[i].HouseName + "</li>";
                            }
                        }
                    ...
                    success: function (result) {
                        ...
                        if (data.length < 5) {
                            ...
                            for (var i = 0; i < data.length; i++) {
                                ...
                                html += "<li name='" + data[i].ID + "' class='" + result[i].class + "' style='text-align:center;line-height:7vh;height:7vh;width:32%;display:inline-block;border-radius: 5px;color:#FFFFFF;margin-left:1%;margin-top:1vh;font-size:15px;font-weight:bold;background-color:" + result[i].Color + "'>" + data[i].HouseName + "</li>";
                            }
                        } else {
                            $("#otherHouseInfo").css("padding-top", "2vh");
                            $("#otherHouseInfo").css("text-align", "left");
