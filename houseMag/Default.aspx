...
<body>
    <header id="navbar">
        <img src="images/gh.png" style="height: 30px;" /><span>湖南省机关事务管理局办公用房管理系统</span>
    ...
    <div class="room-detail-show" style="display:none;position:absolute;left:0%;top:0%;background-image: url(images/bgm.jpg)" id="room-detail-show">
        <header>
            <img src="images/gh.png" style="height: 30px;" /><span>湖南省政府大院公有房产管理系统</span>
...
<script>
    ...
    cxymap.init(document.getElementById("DMapContiner"), 'http://192.168.2.212/csmap/', 'http://192.168.2.212/csDx/', 6, 18, 10, 112.9832970673, 28.1142209008);
    var showOrHide = 0;
