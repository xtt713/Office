...
namespace DBUtility
{
     class PubConstant
    {
        ...
        {
            string connectionString = ConfigurationManager.ConnectionStrings[configName].ToString();
            string ConStringEncrypt = ConfigurationManager.ConnectionStrings[configName].ToString();
            if (ConStringEncrypt == "true")
            {
